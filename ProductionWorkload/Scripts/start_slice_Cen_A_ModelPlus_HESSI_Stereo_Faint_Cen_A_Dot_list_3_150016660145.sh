#!/bin/sh
#PBS -N Cen_A_ModelPlus_HESSI_Stereo_Faint_Cen_A_Dot_list-3
...
export JOBTMPDIR="`mktemp -t -d start_slice_Cen_A_ModelPlus_HESSI_Stereo_Faint_Cen_A_Dot_list_3.XXXX`"
cd $JOBTMPDIR

echo "Script: start_slice_Cen_A_ModelPlus_HESSI_Stereo_Faint_Cen_A_Dot_list_3"
cat > rootlogon.C  << EOF
{
// Analysis
...
EOF
$SINGULARITYCMD root -b 'make_Cen_A_ModelPlus_HESSI_Stereo_Faint_Cen_A_Dot_list_sliced.C(1,3)'
ls -la *.root

#!/bin/sh
#PBS -N Cen_A_ModelPlus_HESSI_Stereo_Faint_Cen_A_Dot_list-1
...
export JOBTMPDIR="`mktemp -t -d start_slice_Cen_A_ModelPlus_HESSI_Stereo_Faint_Cen_A_Dot_list_1.XXXX`"
cd $JOBTMPDIR

echo "Script: start_slice_Cen_A_ModelPlus_HESSI_Stereo_Faint_Cen_A_Dot_list_1"
cat > rootlogon.C  << EOF
{
// Analysis
...
EOF
$SINGULARITYCMD root -b 'make_Cen_A_ModelPlus_HESSI_Stereo_Faint_Cen_A_Dot_list_sliced.C(1,1)'
ls -la *.root
